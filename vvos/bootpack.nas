...
LC3:
	DB	" ",0x00
LC2:
	DB	0xE5,0x85,0xB3,0xE9,0x97,0xAD,0xE7,0xA8,0x8B,0xE5,0xBA,0x8F,0x00
[SECTION .text]
	GLOBAL	_HariMain
_HariMain:
	PUSH	EBP
	...
	MOV	DWORD [-1132+EBP],0
	MOV	AL,BYTE [4081]
	SAR	AL,4
	MOV	EDX,EAX
	AND	EDX,7
	MOV	DWORD [-1136+EBP],EDX
	MOV	DWORD [-1140+EBP],-1
	CALL	_init_gdtidt
	CALL	_init_pic
	CALL	_init_pit
	CALL	_io_sti
...
L68:
	...
	ADD	DWORD [-1124+EBP],EAX
	ADD	DWORD [-1120+EBP],EDX
	JS	L71
L44:
...
L38:
	CMP	ESI,438
	JNE	L64
	AND	DWORD [-1132+EBP],-3
	JMP	L64
L84:
	AND	DWORD [-1132+EBP],-2
	JMP	L38
L83:
	OR	DWORD [-1132+EBP],2
	JMP	L37
