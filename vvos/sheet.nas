...
_sheet_updown:
	...
	MOV	EDI,DWORD [32+EAX]
	MOV	EDX,DWORD [24+EAX]
...
L100:
	MOV	EBX,DWORD [8+EBP]
	CMP	DWORD [-16+EBP],ESI
	MOV	DWORD [24+EBX],ESI
	JLE	L101
	TEST	ESI,ESI
	JS	L102
	MOV	EBX,DWORD [-16+EBP]
L107:
	MOV	EDX,DWORD [16+EDI+EBX*4]
	...
	MOV	DWORD [20+ECX],EAX
	MOV	EAX,DWORD [28+EDX]
	MOV	DWORD [28+ECX],EAX
	JG	L107
	MOV	EAX,DWORD [8+EBP]
	LEA	EBX,DWORD [1+ESI]
	MOV	DWORD [20+EDI+ESI*4],EAX
	MOV	EDX,DWORD [8+EBP]
	PUSH	EBX
	MOV	ESI,EDX
...
L102:
	MOV	EBX,DWORD [-16+EBP]
	CMP	EBX,DWORD [16+EDI]
	JGE	L131
L113:
	MOV	EDX,DWORD [24+EDI+EBX*4]
	MOV	ECX,DWORD [20+EDI+EBX*4]
	MOV	EAX,DWORD [EDX]
	MOV	DWORD [24+ECX],EBX
	MOV	DWORD [ECX],EAX
...
L116:
	...
	JL	L135
L127:
	MOV	EDX,DWORD [20+EDI+EBX*4]
	MOV	ECX,DWORD [24+EDI+EBX*4]
	INC	EBX
	MOV	EAX,DWORD [EDX]
	MOV	DWORD [24+ECX],EBX
	MOV	DWORD [ECX],EAX
